...
#define GENCODECS_FIELD(_name, _type, _default_value) _type _name;
#define GENCODECS_FIELD_STRUCT_PTR(_name, _type, _decor)                      \
    struct _type _decor _name;
#define GENCODECS_FIELD_PTR(_name, _type, _decor) _type _decor _name;
...
#define GENCODECS_FIELD_PRINTF(_name, _type, printf_type, _scanf_type)        \
    _type _name;
#define GENCODECS_FIELD_ENUM(_name, _type) enum _type _name;
...
#define GENCODECS_LIST(_type)                                                 \
    struct _type {                                                            \
        int size;
#define GENCODECS_LISTTYPE(_type)             _type *array;
#define GENCODECS_LISTTYPE_STRUCT(_type)      struct _type *array;
#define GENCODECS_LISTTYPE_PTR(_type, _decor) _type *_decor array;
...
#define GENCODECS_ENUM(_name)                          enum _name {
#define GENCODECS_ENUMERATOR(_enumerator, _value)      _enumerator _value,
#define GENCODECS_ENUMERATOR_LAST(_enumerator, _value) _enumerator _value
...
#define GENCODECS_PUB_LIST(_type) void _type##_cleanup(struct _type *self);
...
#define GENCODECS_LIST(_type) static void _type##_cleanup(struct _type *self);
...
#define GENCODECS_PUB_STRUCT(_type)                                           \
    ...
    {
#define GENCODECS_STRUCT(_type)                       static GENCODECS_PUB_STRUCT(_type)
#define GENCODECS_FIELD(_name, _type, _default_value) (void)self->_name;
#define GENCODECS_FIELD_CUSTOM(_name, _key, _type, _decor, _init, _cleanup,   \
                               _encoder, _decoder, _default_value)            \
...
#define GENCODECS_LISTTYPE(_type) __carray_free(self, _type, NULL, NULL);
