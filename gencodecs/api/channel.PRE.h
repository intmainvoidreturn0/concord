...
ENUMERATOR(DISCORD_CHANNEL_GUILD_NEWS_THREAD,
...
FIELD_CUSTOM(Inline,
             ...
             INIT_BLANK,
             CLEANUP_BLANK,
             GENCODECS_JSON_ENCODER_bool,
             GENCODECS_JSON_DECODER_bool,
             false)
STRUCT_END
#endif
...
COND_WRITE(self->type == DISCORD_CHANNEL_GUILD_TEXT
           || self->type == DISCORD_CHANNEL_GUILD_ANNOUNCEMENT)
FIELD_ENUM(type, discord_channel_types)
COND_END
